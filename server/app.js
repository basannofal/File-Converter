...
app.get('/wordtopdf', function(req,res ) {
  res.sendFile(__dirname+'/component/Home.html');
})
//Post the upload file
app.post('/wordtopdf',function(req,res){
  ...
  if(req.files.upfile){
    ...
    file.mv(uploadpath,function(err){
      if(err){
        ...
        res.sendFile(__dirname+'/component/down_html.html')
        });
      }
    });
  }else{
...
app.get('/download', (req,res) =>{
  ...
  app.get('/thankyou',(req,res) => {
      res.sendFile(__dirname+'/component/thankyou.html')
  })
